...
# 网腾无限 AI - 网腾无限AI - 体制内公文与工作汇报专家

**[基于 Vue 3 + Vite + Vanilla CSS 构建的 网腾无限AI - 体制内公文与工作汇报专家 智能实战微应用，具备深色玻璃拟态自适应交互与微信端 H5 体验]**

[Vue 3] · [TypeScript] · [Vite] · [Vanilla CSS] · [开源协议 MIT]

[![GitHub stars](https://img.shields.io/github/stars/WT-Agent/ai-gongwen?style=social)](https://github.com/WT-Agent/ai-gongwen)
[![GitHub license](https://img.shields.io/github/license/WT-Agent/ai-gongwen)](https://github.com/WT-Agent/ai-gongwen/blob/main/LICENSE)
[![Online Demo](https://img.shields.io/badge/Online_Demo-gongwen.wuxian.xyz-indigo?style=flat-square)](https://gongwen.wuxian.xyz)

[在线演示](https://gongwen.wuxian.xyz) · [快速启动](#快速启动) · [核心特性](#核心特性) · [脚手架集成](#脚手架集成说明) · [支持一下](#联系我们与打赏支持)
...
**网腾无限AI - 体制内公文与工作汇报专家** 专注于“**体制内公文与工作汇报专家**”。我们剔除了冗余概念，不搞虚假宣传，只提供极致优雅、即调即用的高完成度微应用前端与边缘网关接口。
...
1. **智能 Prompt 场景引擎**：针对 **体制内公文与工作汇报专家** 领域进行了深度提示词工程优化与共识打分约束。
...
### 1. 克隆项目
```bash
git clone https://github.com/WT-Agent/ai-gongwen.git
cd ai-gongwen
```
...
```bash
# 自动化发版与发布
node bin/cli.js publish ai-gongwen

# 查看当前微应用配置
node bin/cli.js get ai-gongwen

# 动态热更新提示词或模型映射
node bin/cli.js set ai-gongwen prompt "体制内公文与工作汇报专家"
node bin/cli.js set ai-gongwen model deepseek-chat
```
...
- **官方网站**: [https://gongwen.wuxian.xyz](https://gongwen.wuxian.xyz)
- **GitHub Issues**: [提交反馈](https://github.com/WT-Agent/ai-gongwen/issues)
- **反馈邮箱**: us@wuxian.xyz
